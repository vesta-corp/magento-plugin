...
class PaymentAdapter
{
    ...
    {
        $accountName = $this->config->getPaymentConfigData($this->environmentType .'_'. PaymentConfig::KEY_MERCHANT_ACCOUNT_ID);
        $password = $this->config->getPaymentConfigData($this->environmentType .'_'. PaymentConfig::KEY_MERCHANT_PASSWORD);
        $this->merchantName = $this->encryptor->decrypt($accountName);
        $this->merchantPassword = $this->encryptor->decrypt($password);
        $this->routingId = $this->config->getPaymentConfigData($this->environmentType .'_'. PaymentConfig::KEY_ROUTING_ID);
    ...
    {
        if ($type == 'ccauthonly') {
            $apiLink = $this->config->getPaymentConfigData($this->environmentType .'_'. PaymentConfig::KEY_SDK_URL);
