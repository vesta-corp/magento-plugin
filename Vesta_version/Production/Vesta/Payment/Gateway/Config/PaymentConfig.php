...
class PaymentConfig extends \Magento\Payment\Gateway\Config\Config
{
     ...
     * @var string
     */
    protected $methodCode = "vesta_payment";
    ...
    {
        $password = $this->getValue(Config::KEY_MERCHANT_PASSWORD);
    ...
    {
        $accountName = $this->getPaymentConfigData(self::KEY_MERCHANT_ACCOUNT_ID);
    ...
    {
        return $this->getPaymentConfigData(self::KEY_ROUTING_ID);
    }
    /**
     * Get getPartnerKey
     *
    ...
    {
        return $this->getPaymentConfigData(self::KEY_PARTENAR_KEY);
    }
    /**
    ...
    {
        $sdkUrl = $this->getPaymentConfigData(self::KEY_TOKEN_SDK_URL);
